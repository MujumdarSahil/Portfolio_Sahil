...
import { FaExternalLinkAlt, FaUniversity, FaShieldAlt, FaChartLine } from 'react-icons/fa';
import { SiUdemy, SiCoursera, SiIeee, SiKaggle, SiMicrosoft, SiGoogle, SiAmazon, SiCisco, SiComptia } from 'react-icons/si';
...
const iconData: { [key: string]: JSX.Element } = {
  ...
  'cisco': <SiCisco />,
  'comptia': <SiComptia />,
  'offensive-security': <FaShieldAlt />,
